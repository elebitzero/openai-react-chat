...
const ChatBlock: React.FC<Props> = ({block}) => {
    ...
    return (
        <div key={`chat-block-${block.id}`} className="group w-full text-gray-800 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 bg-gray-50 dark:bg-[#444654]">
