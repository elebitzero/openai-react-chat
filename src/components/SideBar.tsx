              ...
              <nav className="flex h-full flex-col p-2" aria-label="Chat history">
                ...
                <div ref={scrollContainerRef}
                  ...
                  <div className="flex flex-col gap-2 pb-2 dark:text-gray-100 text-gray-800 text-sm">
                    <div className="relative overflow-x-hidden" data-projection-id="3"
                                  ...
                                  <li key={convo.id} className="relative z-[15]"
                                    ...
                                    >
                                      ...
                                      {isEditingTitle ? (
                                        ...
                                        <div
                                          className="flex-1 w-full overflow-hidden whitespace-nowrap overflow-ellipsis max-h-5 break-all relative">
                                          {convo.title}
                                        </div>
                                      )}
                                      <div
                                ...
                                return (
                                  <li key={convo.id} className="relative z-[15]"
                                    ...
                                    <button
                                      ...
                                      type="button"
                                      className="flex w-full py-3 px-3 items-center gap-3 relative rounded-md cursor-pointer break-all bg-gray-50 dark:bg-gray-900"
                                    >
                                      <ChatBubbleLeftIcon {...iconProps} />
                                      <div
