  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2px' }}>
        <span className='text-gray-600' style={{ alignSelf: 'flex-start', fontSize: '12px' }}>Slower</span>
        <span className='text-gray-600'  style={{ alignSelf: 'flex-end', fontSize: '12px' }}>Faster</span>
      </div>
      <Slider
