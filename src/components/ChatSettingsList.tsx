      ...
      <div className="w-full chat-settings-grid">
        {chatSettings.map((setting) => (
            <div
                ...
                className="flex items-center gap-4 overflow-hidden cursor-pointer p-2 bg-gray-100 hover:bg-gray-200 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-600"
            >
              ...
              <div className="overflow-hidden">
                ...
                <span className="text-xs line-clamp-3 text-gray-600 dark:text-gray-400">{setting.description}</span>
              </div>
            </div>
        ))}
      </div>
