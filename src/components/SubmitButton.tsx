  ...
  return (
      <Tooltip title={t('send-message')} side="top" sideOffset={0}>
        <button
            ...
            className="p-1 mr-2 rounded-md text-black dark:text-white enabled:text-white dark:enabled:text-black enabled:bg-black dark:enabled:bg-white disabled:opacity-40 relative z-10"
        >
          {loading ? (
